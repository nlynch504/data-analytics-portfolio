...
def main(argv):
	...
	samsungRe = re.compile(r" samsung.*?galaxy.*?(review|critique|look\sat|in\sdepth|analysis|evaluat|assess)", re.IGNORECASEs	sonyRe = re.compile(r" sony.*?xperia.*?(review|critique|look\sat|in\sdepth|analysis|evaluat|assess)", re.IGNORECASE)
